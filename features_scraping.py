...
if __name__ == '__main__':
    ...
    new_1 = data[['name_game', 'platform']][:1000].copy() # 9
    new_2 = data[['name_game', 'platform']][1000:2000].copy() # 9
    new_3 = data[['name_game', 'platform']][2000:3000].copy() # 9
    new_4 = data[['name_game', 'platform']][3000:4000].copy() # 9
    new_5 = data[['name_game', 'platform']][4000:5000].copy() # 9
    new_6 = data[['name_game', 'platform']][5000:6000].copy() #9
    new_7 = data[['name_game', 'platform']][6000:7000].copy() # 9
    new_8 = data[['name_game', 'platform']][7000:].copy()#29
    ...
    result.to_csv('comeon.csv', index=False)
